...
CREATE procedure [dbo].[sp_ssrs_DIFFBOT_PhysicianRatingUpdate_Table_Original] (@Database nvarchar(200))
...
exec sp_ssrs_DIFFBOT_PhysicianRatingUpdate_Table_Original @Database
*/
...
insert #ratings exec sp_ssrs_DIFFBOT_BarChart @Database
...
insert #volume exec sp_ssrs_DIFFBOT_PieCharts @Database
