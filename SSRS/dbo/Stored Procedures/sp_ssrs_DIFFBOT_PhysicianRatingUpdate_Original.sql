...
CREATE procedure [dbo].[sp_ssrs_DIFFBOT_PhysicianRatingUpdate_Original] (@Database nvarchar(200))
...
exec sp_ssrs_DIFFBOT_PhysicianRatingUpdate_Original @Database
*/
...
set @sql = @sql + 'where w.BatchID = ''' + cast(@BatchID as nvarchar(10)) + ''' ' + @CR
