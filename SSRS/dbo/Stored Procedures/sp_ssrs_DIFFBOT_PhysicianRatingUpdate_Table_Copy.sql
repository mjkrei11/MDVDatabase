...
CREATE procedure [dbo].[sp_ssrs_DIFFBOT_PhysicianRatingUpdate_Table_Copy] (@Database nvarchar(200), @Month int)
...
exec sp_ssrs_DIFFBOT_PhysicianRatingUpdate_Table_Copy @Database, @Month
*/
...
insert #ratings exec sp_ssrs_DIFFBOT_BarChart_Copy @Database, @Month
...
insert #volume exec sp_ssrs_DIFFBOT_PieCharts_Copy @Database, @Month
