...
CREATE procedure [dbo].[sp_ssrs_DIFFBOT_RemoveBadLinks] (@Database varchar(200), @LinkTarget varchar(4000), @MatchRankOption nvarchar(50))
...
@LinkTarget varchar(4000) = 'http://www.vitals.com/doctors/Dr_Barry_Kenneally.html',
@MatchRankOption nvarchar(50) = 'matched'

exec sp_ssrs_DIFFBOT_RemoveBadLinks @Database, @LinkTarget,  @MatchRankOption
*/
