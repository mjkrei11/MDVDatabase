...
CREATE procedure [dbo].[sp_ssrs_ReputationQA_Groups_Archive](
...
exec sp_ssrs_ReputationQA_Groups_Archive @Database, @CompOption, @RatingsSite, @YearQuarter, @option
*/
...
set @sql = @sql + 'and media.NPI like ''G%'' '
exec(@sql)
