...
CREATE procedure [dbo].[sp_ssrs_LinkVerification_999] (@Database nvarchar(200))
...
--exec sp_ssrs_LinkVerification_999 'CHSBF'
*/
...
begin
	...
	set @sql = @sql + 'and sr.MatchRank in (0, 999) ' + @CR
