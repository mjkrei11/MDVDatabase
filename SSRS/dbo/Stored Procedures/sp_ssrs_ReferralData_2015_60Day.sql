...
CREATE procedure [dbo].[sp_ssrs_ReferralData_2015_60Day](
...
exec sp_ssrs_ReferralData_2015_60Day @Database, @CompetitionOption, @NPIList, @SpecialtyWhere, @CityWhere, @StateWhere, @ReferralCountWhere, @UniqueBeneficiariesWhere, @SameDayReferralsWhere, @ReferringNPIList
*/
...
begin
	...
	set @sql = @sql + 'from [192.168.30.27].[CMS_Referrals].dbo.vw_CMSReferralData_2015_60Day v ' + @CR
