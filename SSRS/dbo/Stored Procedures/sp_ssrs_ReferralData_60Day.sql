...
CREATE procedure [dbo].[sp_ssrs_ReferralData_60Day](
...
exec sp_ssrs_ReferralData_60Day @Database, @CompetitionOption, @NPIList, @SpecialtyWhere, @CityWhere, @StateWhere, @ReferralCountWhere, @UniqueBeneficiariesWhere, @SameDayReferralsWhere, @ReferringNPIList
*/
...
begin
	...
	set @sql = @sql + 'from CMS_Referrals.dbo.vw_CMSReferralData_60Day v ' + @CR
